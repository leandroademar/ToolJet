...
<div style={{textAlign: 'center'}}>
    <img className="screenshot-full" src="/img/platform-overview/integrations-v2.png" alt="Integrations" />
</div>
...
<div style={{textAlign: 'center'}}>
    <img className="screenshot-full" src="/img/platform-overview/tooljet-db.png" alt="ToolJet Database" />
</div>
