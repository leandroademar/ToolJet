...
<div style={{textAlign: 'center'}}>
      <img style={{ width: "100%" }} className="screenshot-full" src="/img/workflows/overview/postgresql-config.png" alt="New Table"  />
</div>
...
<div style={{textAlign: 'center'}}>
    <img className="screenshot-full" src="/img/workflows/overview/message-screenshot.png" alt="Message Screenshot" />
</div>
<br/>
